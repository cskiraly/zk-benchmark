...
function normalProve() {
  pushd "$CIRCUIT_DIR"
  avg_time 10 snarkjs groth16 prove ${CIRCUIT_NAME}_test_0001.zkey witness.wtns proof.json public.json
#  "${TIME[@]}" snarkjs groth16 prove ${CIRCUIT_NAME}_test_0001.zkey witness.wtns proof.json public.json
